...
--
-- Name: deliveries; Type: TABLE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.deliveries OWNER TO freecodecamp;
...
ALTER SEQUENCE public.deliveries_order_id_seq OWNED BY public.deliveries.order_id;
...
--
-- Name: deliveries order_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.deliveries ALTER COLUMN order_id SET DEFAULT nextval('public.deliveries_order_id_seq'::regclass);
...
--
-- Data for Name: deliveries; Type: TABLE DATA; Schema: public; Owner: freecodecamp
--

INSERT INTO public.deliveries VALUES (1, 'farnsworth', 'fake poop', NULL, 1, '250 kyz dr, palm', 6);
INSERT INTO public.deliveries VALUES (2, 'mother', 'anchovies', NULL, 3, '445 lop ave, oak', 1);
INSERT INTO public.deliveries VALUES (3, 'calculon', 'crown', NULL, 5, '121 red st, redwood', 11);
...
--
-- Name: deliveries deliveries_address_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: deliveries deliveries_pkey; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.deliveries
    ADD CONSTRAINT deliveries_pkey PRIMARY KEY (order_id);
...
--
-- Name: deliveries deliveries_galaxy_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: deliveries planet_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--
